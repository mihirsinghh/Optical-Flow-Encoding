import numpy as np
import cv2 as cv
cap = cap = cv.VideoCapture(r"C:\Users\mihir\Research\Gallant Lab\Optical-Flow-Encoding\data\test2_redcross.mp4")
ret, frame1 = cap.read()
...
np.save("outputs/horizontal_flow.npy", hflow)
np.save("outputs/vertical_flow.npy", vflow)
